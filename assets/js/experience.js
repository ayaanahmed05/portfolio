...
const exp = [
  ...
  },
  {
    ...
    desp: "<li>Balanced multiple tasks under tight deadlines, showcasing time management and problem-solving skills.</li> <li>Worked collaboratively with teammates to manage high-volume shifts, coordinate orders efficiently, and maintain a seamless workflow under pressure.</li>",
  },
  {
    title: "Pinchaser",
    cardImage: "assets/images/experience-page/nebs-logo.jpeg",
    place: "Neb's Fun World",
    time: "(2021 - 2023)",
